...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed w-full z-50 bg-[#050505]/95 backdrop-blur-xl border-b border-[#D4C5A5]/10 shadow-2xl transition-all duration-300">
      <div className="w-full px-6 md:px-12 lg:px-8 xl:px-24 h-16 md:h-20 flex items-center justify-between">
        <div
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <span className="text-lg md:text-xl lg:text-xl xl:text-2xl font-premium font-bold tracking-[0.2em] text-[#D4C5A5] uppercase drop-shadow-md whitespace-nowrap leading-none">
              Sicurezza
            </span>
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-8 ml-auto">
          {/* Menu Items */}
          {[
            ...
            <a
              key={link.label}
              className="relative text-[10px] xl:text-xs uppercase tracking-[0.1em] xl:tracking-[0.15em] font-bold text-white/70 hover:text-white transition-colors duration-300 group/link whitespace-nowrap"
              href={link.href}
            >
              {link.label}
          ...
          <a
            ...
            className="ml-2 bg-[#D4C5A5] hover:bg-[#C3B494] text-[#050505] px-3 xl:px-4 py-2 rounded-[1px] text-[10px] xl:text-xs uppercase tracking-[0.1em] xl:tracking-[0.2em] font-black transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(212,197,165,0.3)] whitespace-nowrap"
          >
            Consulta
          </a>
        </div>
